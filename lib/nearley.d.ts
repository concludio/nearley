declare module "nearley" {
    ...
    /**
     * @param position The start and end index of the entire match
     * @param failToken Return this object to reject the parsing
     */
    export type Postprocessor = (data: any[], position: [number, number], failToken: {}) => void;
